# Top Down Game Vector - Project Instructions

## Project Overview
This is a top-down action game with wave-based enemy spawning and progression mechanics built with Phaser 3 and TypeScript. The game features:
